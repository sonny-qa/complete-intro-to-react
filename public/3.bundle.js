	...
	var Details = function (_React$Component) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      /* this gets called just when the component makes it onto the page
	      note: we have to use assignShow ti find the show from redux*/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({
	  ...
	  handleSearchTermEvent: function handleSearchTermEvent(e) {
	    /* this method comes from redux store, it has been 
	    injected into our Header component via connector*/
